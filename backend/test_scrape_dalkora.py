...
def test():
    ...
    for link in all_links:
        ...
        # 달코라 패턴 - 게시판 wr_id, news 등
        if not any(p in href for p in ['wr_id=', 'bo_table', 'news', 'view']):
            continue
        
        if href.startswith('/'):
            href = "https://www.dalkora.com" + href
        elif not href.startswith('http'):
            href = "https://www.dalkora.com/" + href
        
        if 'dalkora.com' not in href:
            continue
